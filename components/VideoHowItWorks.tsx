import { Download, Film, SlidersHorizontal } from "lucide-react";
...
const steps = [
  {
    ...
    description: "Choose one video file or drag it into the upload area.",
  },
  {
    icon: SlidersHorizontal,
    title: "Choose format and options",
    description: "Pick the output format and adjust video settings when you need them.",
  },
  {
    icon: Download,
    title: "Convert and download",
    description: "Start the conversion, then download the finished video when it is ready.",
  },
];
  ...
  return (
    <section id="how-it-works" className="section-fade py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading
          badge="How it works"
          title="A clear video conversion flow"
          description="The video converter keeps the steps simple: upload, choose, convert."
        />
